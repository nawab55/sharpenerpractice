...
//  console.log(email);
  ...
  // Storing data in local storage
    ...
    // localStorage.setItem('email', email);
        ...
        axios.post("https://crudcrud.com/api/d43c1997cac34a72ac869e1286f4ece5/appoinmentData", obj)
            .then((response)=>{
...
// read data from cloud(crudcrud)
    window.addEventListener("DOMContentLoaded", () => {
        const data = axios.get("https://crudcrud.com/api/d43c1997cac34a72ac869e1286f4ece5/appoinmentData")
            .then((response)=>{
                console.log(response);
...
// read data from local storage
    ...
    function showUserOnScreen(user){
        ...
        childHTML = `<li id=${user._id}> ${user.name}: ${user.email}:
                    ...
                    <button onclick = editUserDetails('${user.email}','${user.name}','${user._id}')>EditUser</button>
                </li>`
    ...
    // deleteuser('abc@gmail.com')
        function deleteUser(userId){
            axios.delete(`https://crudcrud.com/api/d43c1997cac34a72ac869e1286f4ece5/appoinmentData/${userId}`)
                .then((response)=> {
